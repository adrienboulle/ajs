...
var getArgs = function (cls, context) {
    return (Reflect
        ...
        if (context.serviceMap.has(param)) {
            var S = param;
            if (S === index_1.ElementRef) {
                returned = new index_1.ElementRef(context.node);
            }
            else if (S === index_1.DOCUMENT) {
...
var bootstrap = function (app) {
    ...
    serviceMap.set(index_1.ElementRef, true);
    serviceMap.set(index_1.DOCUMENT, true);
